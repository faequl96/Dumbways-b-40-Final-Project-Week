...
button.addEventListener('click', function() {
    ...
    if(dataForm.nama.value != "" && dataForm.email.value != "" && dataForm.phone.value != "" && dataForm.subject.value != "" && dataForm.message.value != "") {
        ...
        a.href = `https://mail.google.com/mail/?view=cm&fs=1&to=${dataForm.emailReceiver}&su=${dataForm.subject}&body=Halo, saya ${dataForm.nama}, ${dataForm.message}, silahkan hubungi nomor ${dataForm.phone}`;
        a.target = '_blank'
        a.click()
